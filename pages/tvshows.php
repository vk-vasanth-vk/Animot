<body>
  ...
  <div class="backg">
    <video class= "video-bg" autoplay muted loop id="myVideo">
      <source src="tvshow001.mp4" type="video/mp4">
    </video>
  </div>
    ...
    <div class="frame-1">
      <div class="yonk">
        ...
        <a href="index.html"> <button[border-none]type="button" name="button" class="home">LOG OUT</button> </a>
      </div>
      <div class="rectangle">
        <div class="rec"></div>
          <p class="if1">
      ...
      <div class="container">
        <form method="POST">
        <input type="text" placeholder="H U R R Y - U P !" name="TV">
        <div class="btn">
        </form>
...
{
$tv = $_POST['TV'];
$lowercase = strtolower($tv);

if($lowercase == "the walking dead")
{
  header("Location: twd.php");
}
elseif($lowercase == "the haunting of hill house")
{
  header("Location: thohh.php");
}
elseif ($lowercase == "the 100")
{
  header("Location: 100.html");
}
elseif ($lowercase == null)
{
  echo"<div style= 'position: relative; color: red;'>Enter a tv-show</div>";
}
else
{
  echo"<div style= 'position: relative; color: red;'>Data not found!</div>";
}
}
 ?>
