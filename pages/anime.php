<body>
  ...
  <div class="backg">
    <video class= "video-bg" autoplay muted loop id="myVideo">
      <source src="anime30s.mp4" type="video/mp4">
    </video>
  </div>
    ...
    <div class="frame-1">
      ...
      <div class="container">
       <form method="POST">
           <input type="text" placeholder="Search Here BAKA!" name="ANIME">
           <div class="btn">
...
{
$anime = $_POST['ANIME'];
$lowercase = strtolower($anime);

if($anime == "86" || $lowercase  == "eighty six")
{
  header("Location: 86.php");
}
elseif($lowercase == "evangelion" )
{
  header("Location: eva.php");
}
elseif ($lowercase == "steinsgate")
{
  header("Location: steinsgate.php");
}
elseif ($anime == null)
{
